 ...
 */
public class ActivityChineseCharacter extends ActivityBase implements IModelHanZi, View.OnClickListener {
    private static final short CHINESE_CHARACTER_NUM = 36;
    private GridView grid_view_zi;
    private ListView list_view_chinese_character_and_stroke;
